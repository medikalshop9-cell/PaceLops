    ...
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <Card className="shadow-[0_1px_3px_rgba(0,0,0,0.06),0_8px_24px_rgba(0,0,0,0.04)] border-border/40 border">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-[20px] font-medium">Create an account</CardTitle>
          <CardDescription>
          ...
          <form>
            <FieldGroup>
              <Field>
                ...
                <Input id="name" type="text" placeholder="John Doe" required className="h-10" />
              </Field>
              <Field>
              ...
              <Field>
                ...
                <Input id="confirm-password" type="password" required className="h-10" />
              ...
              <FieldGroup>
                <Field>
                  ...
                  <FieldDescription className="text-center pt-2">
                    Already have an account? <button type="button" onClick={onLoginClick} className="font-medium text-slate-900 hover:underline">Sign in</button>
                  </FieldDescription>
                </Field>
              </FieldGroup>
            </FieldGroup>
      ...
      <FieldDescription className="px-6 text-center text-xs text-muted-foreground/80">
        By clicking create account, you agree to our <a href="#" className="underline hover:text-slate-900">Terms of Service</a>{" "}
