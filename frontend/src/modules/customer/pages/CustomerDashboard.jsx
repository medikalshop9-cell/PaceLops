...
export default function CustomerDashboard() {
  ...
  return (
    <div className="py-8 space-y-10 pb-24">
      {/* Hero Card */}
      <div className="relative overflow-hidden rounded-[32px] bg-gradient-to-br from-[#12182B] to-[#0A0E1A] p-10 md:p-12 border border-white/5 shadow-[0_20px_40px_rgba(0,0,0,0.4)]">
        ...
        <div className="relative z-10 flex flex-col md:flex-row justify-between gap-8 h-full">
          ...
          <div className="flex flex-col justify-center">
            <p className="text-slate-400 text-sm font-medium tracking-wide mb-3">Active shipments</p>
            <p className="text-5xl lg:text-7xl font-bold text-white tracking-tight mb-4">3</p>
          ...
          <div className="relative flex-1 flex justify-center items-center py-4 md:py-0 pointer-events-none">
            <img 
              src={truckViz} 
          ...
          <div className="flex flex-col justify-center items-start md:items-end text-left md:text-right">
            <p className="text-slate-400 text-sm font-medium tracking-wide mb-3">Delivered this month</p>
            <p className="text-5xl lg:text-7xl font-bold text-white tracking-tight mb-4">27</p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          ...
          return (
            <div 
              key={i}
              className={`group relative overflow-hidden rounded-[24px] p-6 cursor-pointer transition-all duration-300 hover:scale-[1.02] border ${
                action.primary 
            ...
            >
              ...
              <div className="relative z-10 flex flex-col h-full">
                <div className={`w-12 h-12 rounded-2xl flex items-center justify-center mb-6 shadow-inner ${
                  action.primary ? 'bg-[#FF7A00]/20 text-[#FF7A00]' : 'bg-white/5 text-slate-300 group-hover:bg-white/10'
                }`}>
                ...
                <div className="flex items-center justify-between mb-1">
                  ...
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center transition-colors ${
                    action.primary ? 'bg-[#FF7A00] text-white shadow-lg shadow-[#FF7A00]/40' : 'bg-white/5 text-slate-400 group-hover:text-white group-hover:bg-white/10'
                  }`}>
